...
namespace RDKit
{
    public static partial class Chem
    {
        ...
        public static string GetAtomAlias(Atom atom) => RDKFuncs.getAtomAlias(atom);

        public static int GetAtomRLabel(Atom atom) => RDKFuncs.getAtomRLabel(atom);

        public static string GetAtomValue(Atom atom) => RDKFuncs.getAtomValue(atom);

        public static PeriodicTable GetPeriodicTable() => PeriodicTable.getTable();
